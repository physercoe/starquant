...
class PositionHolding:
    ...
    def convert_order_request_lock(self, req: OrderRequest):
        ...
        # then open new position
            ...
            if yd_available:
                req_yd = copy(req)
                #only close yd volume than can be closed
                req_yd.volume = min(req.volume, yd_available)
