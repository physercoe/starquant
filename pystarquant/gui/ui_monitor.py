...
from pystarquant.common.datastruct import Event, SubscribeRequest
from pystarquant.common.constant import EventType, MSG_TYPE, ACTIVE_STATUSES, SYMBOL_TYPE
...
class OrderMonitor(BaseMonitor):
    ...
    def cancel_order(self, cell):
        ...
        if order.api != 'FUTU':
            ...
            m = Event(type=EventType.GENERAL_REQ, data=order,
                    src='0', msgtype=MSG_TYPE.MSG_TYPE_CANCEL_ORDER)
        self.event_engine.put(m)
