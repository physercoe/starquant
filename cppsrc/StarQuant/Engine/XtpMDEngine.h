...
#ifndef CPPSRC_STARQUANT_ENGINE_XTPMDENGINE_H_
#define CPPSRC_STARQUANT_ENGINE_XTPMDENGINE_H_
...
namespace StarQuant
{
class XtpMDEngine : public IEngine, XTP::API::QuoteSpi {
 public:
    string name_;
    Gateway xtpacc_;
 ...
 private:
    ...
    string xtpExchange2string(XTP_EXCHANGE_TYPE exchange_id);
    XTP_EXCHANGE_TYPE string2XtpExchange(const string& exchangeid);
    char xtpSecType2SQ(XTP_TICKER_TYPE stype);

};
}  // namespace StarQuant

#endif  // CPPSRC_STARQUANT_ENGINE_XTPMDENGINE_H_
