...
namespace StarQuant
{
	...
	bool BarSeries::newTick(const Tick& k)
	{
		...
		if ((k.msgtype_ != MSG_TYPE::MSG_TYPE_Trade) && ((k.msgtype_ != MSG_TYPE::MSG_TYPE_Full)))		// at this time only consier trade
			return false;
	...
	string BarSeries::serialize() const
	{
		...
		ostringstream os;
		os << to_string(MSG_TYPE_BAR_15MIN)  //TODO: differentiate type 
